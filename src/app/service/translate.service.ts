...
export class TranslateService {
  private translations: Translations = {
    pt: {
      ...
      'calculator.stations': 'Número de Postos',
      'calculator.station_prices': 'Preços por Posto',
      'calculator.station': 'Posto',
      ...
      'calculator.per_station': 'Valor médio por posto de combustível',
      'calculator.individual_costs': 'Custos Individuais por Posto',
    ...
    en: {
      ...
      'calculator.stations': 'Number of Stations',
      'calculator.station_prices': 'Prices per Station',
      'calculator.station': 'Station',
      ...
      'calculator.per_station': 'Average value per fuel station',
      'calculator.individual_costs': 'Individual Costs per Station',
